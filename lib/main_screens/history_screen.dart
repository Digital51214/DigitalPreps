...
Widget _buildStatusCard({
  ...
  return Container(
    ...
    child: Row(
      children: [
        /// 🔵 LEFT SIDE (fully aligned to edge)
        Expanded(
          child: Padding(
        ...
        /// 🔴 RIGHT SIDE (gradient edge stuck)
        Container(
          width: 10, // fixed thin bar
          decoration: BoxDecoration(
                ...
                child: Row(
                  ...
                  children: [
                    _buildStatusCard(
                      ...
                      count: '22',
                      gradientColors: [
                        Color(0xFF36BCFF).withOpacity(0),
                        Color(0xFF2B96CC),
                        Color(0xFF207199).withOpacity(0),
                      ],
                      w: w,
                      h: h,
                    ),
                    _buildStatusCard(
                      ...
                      count: '01',
                      gradientColors: [
                        Color(0xFFFF3E40).withOpacity(0),
                        Color(0xFFCC3233),
                        Color(0xFF992526).withOpacity(0),
                      ],
                      w: w,
                      h: h,
                    ),
                    _buildStatusCard(
                      ...
                      count: '01',
                      gradientColors: [
                        Color(0xFF061B44).withOpacity(0),
                        Color(0xFF0B2F77),
                        Color(0xFF0F43AA).withOpacity(0),
                      ],
                      w: w,
                      h: h,
                    ),
